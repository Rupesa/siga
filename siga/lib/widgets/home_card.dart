...
class Home_card extends StatelessWidget {
  ...
  factory Home_card.fromDocument(DocumentSnapshot doc) {
    return Home_card(
      profile_img: doc["userUrl"],
      profile_name: doc["username"],
      event_img: doc["mediaUrl"],
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.cover, image: NetworkImage(event_img)))),
            ),
            Container(
              height: double.infinity,
              width: 170.0,
